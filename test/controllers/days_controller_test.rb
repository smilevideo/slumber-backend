...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { date: @day.date, note: @day.note, rating: @day.rating, user_id: @day.user_id } }, as: :json
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { date: @day.date, note: @day.note, rating: @day.rating, user_id: @day.user_id } }, as: :json
    assert_response 200
  end
